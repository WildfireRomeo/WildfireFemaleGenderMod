...
public class WardrobeBrowserScreen extends BaseWildfireScreen {
	...
	public void init() {
		...
		this.addDrawableChild(new WildfireButton(this.width / 2 - 42, j - 52, 158, 20,
				getGenderLabel(plr.getGender()),
				button -> {
		...
		this.addDrawableChild(new WildfireButton(this.width / 2 - 42, j - 32, 158, 20,
				Text.translatable("wildfire_gender.appearance_settings.title").append("..."),
		...
		this.addDrawableChild(new WildfireButton(this.width / 2 - 42, j - 12, 158, 20,
				Text.translatable("wildfire_gender.char_settings.title").append("..."),
		...
		this.addDrawableChild(new WildfireButton(this.width / 2 + 111, j - 63, 9, 9,
	...
	public void render(MatrixStack m, int f1, int f2, float f3) {
		...
		drawTexture(m, (this.width - 248) / 2, (this.height - 134) / 2, 0, 0, 248, 156);
		...
		try {
		    ...
		    if(ent != null) {
		    	drawEntityOnScreen(xP, yP, 45, (xP - f1), (yP - 76 - f2), ent);
		    } else {
